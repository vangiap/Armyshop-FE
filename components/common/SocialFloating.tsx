    ...
    <div className="fixed bottom-24 right-4 z-40 flex flex-col gap-3">
      ...
      {(settings.contact_hotline || settings.contact_phone) && (
        <a
          ...
          className="group relative flex items-center justify-center w-12 h-12 bg-green-500 rounded-full shadow-lg hover:scale-110 transition-transform duration-200"
          title="Gọi ngay"
        >
