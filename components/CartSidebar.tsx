...
const CartSidebar: React.FC = () => {
  const { cartItems, isCartOpen, toggleCart, updateQuantity, removeFromCart } = useShop();
                    ...
                    <div className="ml-4 flex flex-1 flex-col justify-between">
                      ...
                      <div className="flex flex-1 items-end justify-between text-sm mt-2">
                        <div className="flex items-center border border-gray-300 rounded-md shadow-sm">
                          ...
                          <button 
                            onClick={() => updateQuantity(item.id, item.selectedColor, item.selectedSize, 1)}
                            className="p-1 px-2 hover:bg-gray-50 text-gray-600 transition-colors rounded-r-md"
                          >
